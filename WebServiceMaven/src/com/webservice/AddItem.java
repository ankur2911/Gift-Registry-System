...
public class AddItem {
	...
	public String add(@FormParam("userIDcheck") String userIDcheck,@FormParam("userID") int userID,
		...
		System.out.println("*************************************************");
		System.out.println("inside add_item WEBservice"+ registry_id+"---"+item_code);
		...
		if(v.validate(userIDcheck, userID)){
			...
			WebResource webresource= client.resource("https://localhost:8444/MicroServiceMaven/backend/AddItem/"+output_encrypt+"/"+registry_id+"/"+item_code);
	    ...
	    System.out.println("addRESULT="+myObj.toString());
	    System.out.println("*************************************************");
