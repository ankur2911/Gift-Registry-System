...
public class UpdateAnswer {
	...
	public String loginUser(@FormParam("userIDcheck") String userIDcheck,@FormParam("userID") int userID,
		...
		System.err.println("inside update answer WEBservice");
		...
		if(v.validate(userIDcheck, userID)){
			...
			WebResource webresource= client.resource("https://localhost:8444/MicroServiceMaven/backend/updateAnswer/"+output_encrypt+"/"+answer);
	    ...
	    System.out.println("updateAnswerRESULT="+myObj.toString());
	    System.out.println("*************************************************");
